...
tipos = ["Arbol", "Biodiversidad", "Cargadores", "Zonas", "Parkings", "EquiposClimatizacion", "Contenedores"];//=================================== AQUI

function menuInformacion(){//=================================== AQUI
    g_ent = ["Árboles", "Biodiversidad", "Cargadores eléctricos", "Zonas", "Parkings de Bicis", "Equipos de Climatización", "Contenedores UMA"];
    inf_ent = ["Muestra de la arboleda exsistente en el Boulevar Louis Pasteur del Campus de Teatinos.",
               ...
               "Distribución y tipología de los contenedores que la comunidad puede encontrar en por los distintos campus de la universidad, así como el tipo de residuo que corresponde a depositar en cada uno de ellos."];
}
...
function traductorAtributos(type, atributoBuscado) {
    ...
    if(type.localeCompare(tipos[6]) == 0){//=================================== AQUI
        //Contenedores UMA
        var atributos = ["description", "Residuos"];
        var atributosTraducidos = ["Tipo de contenedor", "Variedad de residuos"];
    }
    //===========================================================================================================
...
function buscadorEstilosIconSelected(type, feature) {
    ...
    } else if (type.localeCompare(tipos[6]) == 0) {
        enlace = 'http://osm.uma.es/Iconos/Contenedores/contenedor_2.png';
    } else {
