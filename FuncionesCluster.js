...
function clusterStyle_6(feature, resolution) {//=================================== AQUI
    var size = feature.get('features').length;
    var tipoEntidad = feature.get('features')[0].get('name');
    var pointStyle = getCircleStyle(size, tipoEntidad);
    if (size > 1) {
...
function buscadorEstilosIcon(tipoEntidad) {
    ...
    } else if (tipoEntidad.localeCompare(tipos[6]) == 0) {//=================================== AQUI
        enlace = 'http://osm.uma.es/Iconos/Contenedores/contenedor_1.png';
    } else {
...
function buscadorEstilosCluster(type) {
    ...
    } else if (type.localeCompare(tipos[6]) == 0){//=================================== AQUI
        color_relleno = 'rgb(53, 239, 242)';
    }else {
